import unittest
from užduotis1 import skaiciu_suma, didziausias_skaicius, sakinys_atvirksciai, ar_yra, patikrinti_sakini, lyginiai_skaiciai
...
class TestUzduotis1(unittest.TestCase):
    ...
    def test_didziausas_skaicius(self):
    ...
    def test_ar_yra(self):
        self.assertEqual(ar_yra(5, [5, 6, 7, 9, 10, 15, 45, 100]))
